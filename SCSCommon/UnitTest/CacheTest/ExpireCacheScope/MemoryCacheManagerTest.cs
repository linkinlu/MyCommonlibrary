   ...
   public class MemoryCacheManagerTest
    {
        ...
        public void ToTest()
        {
            ...
            //cache.Add("BB", new TestA() { A = 1 }, new TimeSpan(0, 0, 60), "b");
            //cache.Add("AA", new TestA() { A = 1 }, new TimeSpan(0, 0, 60), "a");
            //cache.Add("CC", new TestA() { A = 1 }, new TimeSpan(0, 0, 60), "ab");
            //cache.Add("DD", new TestA() { A = 1 }, new TimeSpan(0, 0, 60), "d");
